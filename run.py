...
Author    = 'Abu Huraira Rafa'
Facebook  = 'Facebook.com/ItzMeRafa'
Instagram = 'Instagram.com/abuhurairarafa'
Whatsapp  = '+8801302249809'
YouTube   = 'youtube.com/channel/UC_IVc9T7w_T8zfSYoH9M5-w'
Version   = '0.6'
Denventa  = 1827084332
...
def poster():
    ...
    l6 = ('     %s Multi Brute Force Facebook %s%s %sBy %sRafa     '%(P,J,Version,P,J))
    print('%s\n%s\n%s\n%s\n%s\n%s'%(l1,l2,l3,l4,l5,l6))
def poster2():
    l1 = ('     %s  _________       __                          '%(P))
    ...
    l6 = ('     %s Multi Brute Force Facebook %s%s %sBy %sRafa     '%(P,H,Version,P,H))
    print('%s\n%s\n%s\n%s\n%s\n%s'%(l1,l2,l3,l4,l5,l6))
def poster3():
    l1 = ('     %s  _________       __                          '%(P))
    ...
    l6 = ('     %s Multi Brute Force Facebook %s%s %sBy %sRafa     '%(P,B,Version,P,B))
    print('%s\n%s\n%s\n%s\n%s\n%s'%(l1,l2,l3,l4,l5,l6))
...
def user(nama):
    ...
    print('        %s[%s•%s] %sYour License Will Expire In %s30 %sDays'%(J,P,J,P,A,P))
def tampilan_menu():
